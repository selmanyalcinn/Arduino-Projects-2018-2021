...
const char* ssid = "LinyitNnet_yalcin"; // Enter the SSID of your WiFi Network.
const char* password = "kamil1616";// Enter the Password of your WiFi Network.
...
byte sendEmail()
{
  ...
  */
  espClient.println("dWx0aW1hdGVib3cxMjM0");//base64, ASCII encoded Password
  if (!emailResp()) 
    return 0;
  //
  Serial.println(F("Sending From"));
  // change to sender email address
  espClient.println(F("MAIL From: selmanyalcin16@gmail.com"));
  if (!emailResp()) 
    return 0;
  // change to recipient address
  Serial.println(F("Sending To"));
  espClient.println(F("RCPT To: selmanyalcin16@gmail.com"));
  if (!emailResp()) 
    return 0;
  //
